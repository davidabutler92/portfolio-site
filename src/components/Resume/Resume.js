        ...
        >
          <Grid item container className={classes.experienceContainer}>
            ...
            <Grid item xs={12}>
              ...
              >
                This was a remote collaboration for Rapid Oregon. Developed and
                maintained an accessibility first social media platform on a
                dynamic team of volunteers. Implemented React, React Native, and
                Redux code across 3 separate web portals and a mobile
                application. Worked closely with team members to integrate
                application objectives into sustainable design practices.
              </ResumeItem>
            </Grid>
          </Grid>
